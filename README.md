...
An implementation of [Verkle trees]([https://notes.ethereum.org/nrQqhVpQRi6acQckwm1Ryg](https://dankradfeist.de/ethereum/2021/06/18/verkle-trie-for-eth1.html)). When production-ready, the code is to be merged back into go-ethereum.
